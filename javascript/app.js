...
// ---------slice() method ----> it is used to extract a part of a string and return it as a new string.
// let str ="hello";
...
// ------------replace() method ----> it is used to replace a specified value with another value in a string.
...
//-------repeat() method ----> it is used to repeat a string a specified number of times.
// let str = "Mango";
